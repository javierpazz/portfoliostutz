...
<div>
  ...
  {/* ourwines Modals*/}
  {/* ourwines item 1 modal popup*/}
  <div className="ourwines-modal modal fade" id="ourwinesModal1" tabIndex={-1} role="dialog" aria-hidden="true">
  ...
  {/* ourwines item 2 modal popup*/}
  <div className="ourwines-modal modal fade" id="ourwinesModal2" tabIndex={-1} role="dialog" aria-hidden="true">
    <div className="modal-dialog">
      <div className="modal-content">
        <div className="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg" alt="Close modal" /></div>
        <div className="container">
  ...
  {/* ourwines item 3 modal popup*/}
  <div className="ourwines-modal modal fade" id="ourwinesModal3" tabIndex={-1} role="dialog" aria-hidden="true">
    <div className="modal-dialog">
      <div className="modal-content">
        <div className="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg" alt="Close modal" /></div>
        <div className="container">
  ...
  {/* ourwines item 4 modal popup*/}
  <div className="ourwines-modal modal fade" id="ourwinesModal4" tabIndex={-1} role="dialog" aria-hidden="true">
    <div className="modal-dialog">
      <div className="modal-content">
        <div className="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg" alt="Close modal" /></div>
        <div className="container">
  ...
  {/* ourwines item 5 modal popup*/}
  <div className="ourwines-modal modal fade" id="ourwinesModal5" tabIndex={-1} role="dialog" aria-hidden="true">
    <div className="modal-dialog">
      <div className="modal-content">
        <div className="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg" alt="Close modal" /></div>
        <div className="container">
  ...
  {/* ourwines item 6 modal popup*/}
  <div className="ourwines-modal modal fade" id="ourwinesModal6" tabIndex={-1} role="dialog" aria-hidden="true">
    <div className="modal-dialog">
      <div className="modal-content">
        <div className="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg" alt="Close modal" /></div>
        <div className="container">
